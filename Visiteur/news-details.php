...
<head>
    ...
    <title>News Details || Udemey</title>
    <!-- favicons Icons -->
                            ...
                            <div class="main-header--one__top-contact-info clearfix">
                                <ul class="main-header--one__top-contact-info-list list-unstyled">
                                    ...
                                    <li class="main-header--one__top-contact-info-list-item">
                                        ...
                                        <div class="text">
                                            <h6>Call Agent</h6>
                                            <p><a href="mailto:salmabouizmoune@gmail.com">salmabouizmoiune@gmail.com</a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="sidebar__post-content">
                                        <ul class="list-unstyled">
                                            <li>
                                                ...
                                                <h3><a href="news-details.php">Learn how access to new courses</a></h3>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
