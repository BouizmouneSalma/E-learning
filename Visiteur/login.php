    ...
    <div class="page-wrapper">
                            ...
                            <div class="main-header--one__top-contact-info clearfix">
                                <ul class="main-header--one__top-contact-info-list list-unstyled">
                                    ...
                                    <li class="main-header--one__top-contact-info-list-item">
                                        ...
                                        <div class="text">
                                            <h6>Call Agent</h6>
                                            <p><a href="mailto:info@templatepath.com">salmabouizmoune@gmail.com</a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="main-menu__right">
                                        <div class="main-menu__right-login-register">
                                            <ul class="list-unstyled">
                                                <li class="dropdown current"><a href="./login.php">Login</a></li>
        ...
        <div class="registration-one__left">
            <div class="section-title">
                <span class="section-title__tagline">Welcome Back!</span>
                <h2 class="section-title__title">Log In to Your Account<br> Access Over <span
                        class="odometer" data-count="66000">00</span> <br>Exclusive Online Courses</h2>
            </div>
            <p class="registration-one__left-text">Continue your learning journey with unlimited access to thousands of
                courses created by expert instructors.</p>
            <div class="registration-one__left-transform-box">
                ...
                <div class="registration-one__left-transform-box-text">
                    <h3><a href="#">Log In and Learn</a></h3>
                    <p>Reconnect with your passion for knowledge and take your skills to the next level with our
                        comprehensive courses.</p>
                </div>
            </div>
        </div>
    </div>
