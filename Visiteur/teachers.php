...
<body>
    ...
    <section class="meet-teachersne meet-teachersne--teachers">
        <div class="container">
            <div class="row">
                <!--Start Single Meet Teachers One-->
                <div class="col-xl-4 col-lg-4">
                    <div class="meet-teachersne__single wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="meet-teachersne__single-img">
                            <img src="../assets/images/resources/meet-teachers1-img4.png" alt=""/>
                        </div>

                        <div class="meet-teachersne__single-content">
                            <div class="meet-teachersne__single-middle-content">
                                <div class="title">
                                    <h4><a href="#">Jessica Brown</a></h4>
                                    <p>teacher</p>
                                </div>
                                <p class="meet-teachersne__single-content-text">There are many varia of passages the free ipsum lorem.</p>
                            </div>

                            <div class="meet-teachersne__single-bottom-content">
                                <div class="meet-teachersne__single-content-courses-box">
                                    <div class="text">
                                        <p>20 Courses</p>
                                    </div>
                ...
                <!--Start Single Meet Teachers One-->
                <div class="col-xl-4 col-lg-4">
                    <div class="meet-teachersne__single wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                        <div class="meet-teachersne__single-img">
                            <img src="../assets/images/resources/meet-teachers1-img5.png" alt=""/>
                        </div>
                ...
                <!--Start Single Meet Teachers One-->
                <div class="col-xl-4 col-lg-4">
                    <div class="meet-teachersne__single wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="meet-teachersne__single-img">
                            <img src="../assets/images/resources/meet-teachers1-img6.png" alt=""/>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="registration-two__wrapper">
                        ...
                        <div class="registration-two__left">
                            <h2 class="registration-two__left-text">Start Your Education Career <br>with YouDemy</h2>
                        </div>
        ...
        <div class="mobile-nav__content">
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    ...
                    <a href="mailto:needhelp@packageName__.com">needhelp@YouDemy.com</a>
                </li>
                <li>
