...
<body>
    ...
    <!--Page Header Start-->
    <section class="page-header clearfix" style="background-image: url(../assets/images/backgrounds/news.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                    <div class="blog-one__single">
                        ...
                        <div class="blog-one__single-content">
                            ...
                            <h2 class="blog-one__single-content-title"><a href="news-details.php">Helping Answers Stand out in Discussions</a></h2>
